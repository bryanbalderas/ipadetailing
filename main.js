function setLanguage(lang) {
    ...
    if (lang === 'es') {
        document.getElementById('headTitle').innerText = 'Excelencia para tu coche';
        ...
        document.getElementById('headTitle3').innerText = 'Lavado Premium - $50/60*';
        document.getElementById('combo1Text').innerHTML = '<li>Lavado a mano completo</li><li>Limpiar ruedas y neumáticos</li><li>Lavado con espuma</li><li>Limpiar ventanas exteriores</li><li>Vestido de neumáticos</li><li>Jambas de puertas</li><li>Secado con toalla y soplador de aire</li><li>Cera en spray premium sellada para hasta 30 días de protección</li><li>Vestir todos los adornos y plásticos exteriores</li>';
        document.getElementById('headTitle4').innerText = 'Lavado y Cera - $120/140*';
        document.getElementById('combo2Text').innerHTML = '<li>Lavado a mano completo</li><li>Limpiar ruedas y neumáticos</li><li>Lavado con espuma</li><li>Descontaminación de hierro</li><li>Exfoliación con barra de arcilla</li><li>Limpiar ventanas exteriores</li><li>Vestido de neumáticos</li><li>Jambas de puertas</li><li>Cera en spray cerámica</li><li>Vestir todos los adornos y molduras exteriores</li>';
        document.getElementById('headTitle5').innerText = 'Detalle Interior Completo - $200/$280*';
        ...
        document.getElementById('headTitle6').innerText = 'Detalle Interior Mini - $40/60*';
        ...
        document.getElementById('headTitle').innerText = 'Excellence for your car';
        ...
        document.getElementById('headTitle3').innerText = 'Premium Wash - $50/60*';
        ...
        document.getElementById('headTitle5').innerText = 'Full Interior Detail - $200/$280*';
        ...
        document.getElementById('headTitle6').innerText = 'Mini-Interior Detail - $40/60*';
